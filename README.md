...
Download a binary for your platform from the [v0.1.28 release](https://github.com/okt4v/ASAT/releases/tag/v0.1.28):

| Platform | Link |
|----------|------|
| Linux x86_64 (glibc) | [asat-x86_64-unknown-linux-gnu.tar.gz](https://github.com/okt4v/ASAT/releases/download/v0.1.28/asat-x86_64-unknown-linux-gnu.tar.gz) |
| Linux x86_64 (musl)  | [asat-x86_64-unknown-linux-musl.tar.gz](https://github.com/okt4v/ASAT/releases/download/v0.1.28/asat-x86_64-unknown-linux-musl.tar.gz) |
| Linux aarch64        | [asat-aarch64-unknown-linux-gnu.tar.gz](https://github.com/okt4v/ASAT/releases/download/v0.1.28/asat-aarch64-unknown-linux-gnu.tar.gz) |
| macOS arm64          | [asat-aarch64-apple-darwin.tar.gz](https://github.com/okt4v/ASAT/releases/download/v0.1.28/asat-aarch64-apple-darwin.tar.gz) |
| macOS x86_64         | [asat-x86_64-apple-darwin.tar.gz](https://github.com/okt4v/ASAT/releases/download/v0.1.28/asat-x86_64-apple-darwin.tar.gz) |
| Windows x86_64       | [asat-x86_64-pc-windows-msvc.zip](https://github.com/okt4v/ASAT/releases/download/v0.1.28/asat-x86_64-pc-windows-msvc.zip) |
...
```bash
curl -LO https://github.com/okt4v/ASAT/releases/download/v0.1.28/asat_0.1.28-1_amd64.deb
sudo apt install ./asat_0.1.28-1_amd64.deb
```
