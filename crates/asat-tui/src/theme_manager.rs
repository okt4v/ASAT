        ...
        .map(|(i, t)| {
            ...
            if is_sel {
                ListItem::new(Line::from(vec![
                    ...
                    Span::styled(
                        format!(" {}", dark_indicator),
                        Style::default().fg(darken(hdr_fg, 0.7)),
                    ),
                ]))
                ...
                ListItem::new(Line::from(vec![
                    ...
                    Span::styled(
                        format!(" {}", dark_indicator),
                        Style::default().fg(darken(hdr_fg, 0.5)),
                    ),
                ]))
            }
        })
...
fn render_mock_grid(
    ...
    let header_style = Style::default()
        ...
        .bg(header_bg)
        .add_modifier(Modifier::BOLD);
    let cursor_hdr = Style::default()
        .fg(Color::Black)
        .bg(cursor_bg)
        .add_modifier(Modifier::BOLD);
    let cell_normal = Style::default().fg(Color::White).bg(cell_bg);
    let cell_cursor = Style::default()
        .fg(Color::Black)
        .bg(cursor_bg)
        .add_modifier(Modifier::BOLD);
    ...
    if sy < area.y + area.height {
        ...
        let normal_badge = Style::default()
            .fg(Color::Black)
            .bg(normal_color)
            .add_modifier(Modifier::BOLD);
        frame.render_widget(
